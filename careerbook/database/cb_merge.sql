...
CREATE TABLE `group_details` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT 'group id act as primary key',
  ...
  `created_by` bigint(11) NOT NULL COMMENT 'user id of group creator',
...
CREATE TABLE `group_discussion` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT 'group discussion id act as primary key',
  `group_id` bigint(11) NOT NULL COMMENT 'group id of group',
...
CREATE TABLE `group_discussion_comment` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT 'group comment id act as primary key',
  `discussion_id` bigint(11) NOT NULL COMMENT 'discussion id of group',
...
CREATE TABLE `group_log` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT 'log id act as primary key',
  ...
  `group_id` bigint(11) NOT NULL COMMENT 'group id on which activity perform',
  PRIMARY KEY (`id`)
...
CREATE TABLE `group_members` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT 'primary id',
  `group_id` bigint(11) NOT NULL COMMENT 'group id of group',
  `member_id` bigint(11) NOT NULL COMMENT 'member user id',
  PRIMARY KEY (`id`),
  KEY `fk_group_id` (`group_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `messaging` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT 'messaging id act as primary key',
  `description` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'description of messaging',
  `user_from` bigint(11) NOT NULL COMMENT 'user id of sender',
  `user_to` bigint(11) NOT NULL COMMENT 'user id of reciever',
...
CREATE TABLE `user_academic_info` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'THIS WILL BE AUTO GENERATED UNIQUE ID',
  `user_id` int(11) unsigned NOT NULL COMMENT 'THIS WILL BE USER ID OF USER TABLE',
...
CREATE TABLE `user_discussion` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'THIS WILL BE AUTO GENERATED UNIQUE ID',
  `group_id` int(11) unsigned DEFAULT NULL COMMENT 'THIS WILL BE LINKED TO ID OF GROUP TABLE',
  `topic_description` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'DESCRIPTION OF TOPIC',
  `creted_by` int(11) unsigned NOT NULL COMMENT 'USER ID WHO CREATED DISCUSSION',
...
CREATE TABLE `user_discussion_comments` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'THIS WILL BE AUTO GENERATED UNIQUE ID',
  `discussion_id` int(11) unsigned DEFAULT NULL COMMENT 'THIS WILL BE LINKED TO ID OF DISCUSSION TABLE',
  `comment_discusn_form` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'COMMENT ON Discussion',
  `creadet_by` int(11) unsigned NOT NULL COMMENT 'THIS WILL BE USER ID OF USER TABLE',
  `created_on` datetime NOT NULL COMMENT 'discussion creation time',
  `updated_on` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'last updation time by user',
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `user_old_job_info`
--

DROP TABLE IF EXISTS `user_old_job_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_old_job_info` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'THIS WILL BE AUTO GENERATED UNIQUE ID',
  `user_id` int(11) unsigned NOT NULL COMMENT 'THIS WILL BE USER ID OF USER TABLE',
...
--
-- Dumping data for table `user_old_job_info`
--

LOCK TABLES `user_old_job_info` WRITE;
/*!40000 ALTER TABLE `user_old_job_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_old_job_info` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `user_personal_info` (
  ...
  `mobileno` bigint(11) unsigned DEFAULT NULL COMMENT 'USER VALID MOBILE NUMBER',
...
INSERT INTO `users` VALUES (1,'Administrator',NULL,NULL,'2013-03-01 00:00:00','admin@admin.com',NULL,12345,'male','7d793037a0760186574b0282f2f435','A','2013-03-01 18:26:59','2013-03-01 00:00:00'),(14,'Mohit','K','Singh','1988-09-20 00:00:00','lookforward007@gmail.com',NULL,8375959679,'male','827ccb0eea8a706c4c34a16891f84e7b','A','2013-03-02 07:37:55','2013-03-02 07:37:55'),(17,'Rahul',NULL,'Kumar','1988-09-20 00:00:00','timetorock1001@gmail.com',NULL,8375959679,'male','827ccb0eea8a706c4c34a16891f84e7b','A','2013-03-03 18:07:36','2013-03-03 06:07:36');
...
-- Dump completed on 2013-03-04  0:13:47
